...
class TGListCVC: CoreListCollectionViewController, CLWaterflowLayoutDelegate {
    public func waterflowLayout(_ waterflowLayout: CLWaterflowLayout!, heightForWidth width: CGFloat, at indexPath: IndexPath!) -> CGFloat {
        return 0
    }
...
//    
//    /** 自定义空视图 */
//    override func listVC_StatusView_Empty() -> Any! {
//        return nil
//    }
//    
//    /** 自定义错误视图 */
//    override func listVC_StatusView_Error() -> Any! {
//        return nil
//    }
//    /** 请求参数 */
...
//    override func listVC_Update_Delay_Key() -> String! {return "\(type(of: self))"}
//
//    /** collectionView专有方法 */
